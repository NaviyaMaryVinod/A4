...
survey_df<-read.csv("C:\\Users\\naviy\\Downloads\\Survey.csv",header=TRUE) 
dim(survey_df) 
names(survey_df) 
head(survey_df) 
str(survey_df)
...
icecream_df<-read.csv('C:\\Users\\naviy\\Downloads\\icecream.csv',header=TRUE)
dim(icecream_df)
